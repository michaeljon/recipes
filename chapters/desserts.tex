...
\begin{figure}[!hp]
    ...
    \includegraphics[width=\textwidth]{img/lemon-bar.png}
\end{figure}
...
\begin{figure}[!hp]
    \centering
    \captionsetup{labelformat=empty}
    \includegraphics[width=\textwidth]{img/oatmeal-cookies.png}
\end{figure}
...
\begin{figure}[!hp]
    \centering
    \captionsetup{labelformat=empty}
    \includegraphics[width=\textwidth]{img/snickerdoodles.png}
\end{figure}
