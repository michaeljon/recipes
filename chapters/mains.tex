...
\RecipeNameAndYield{Name=Dad's Chicken Tacos}

\RecipeStory{\lettrine{Y}{ou never know when} you're going to need some
    very simple, but very tasty food. This one is easy to make, but it \emph{does}
    take a long time. There's almost no prep. Throw things in the pan, cover with
    some stock, and let simmer until everything falls apart.

    This is best served wrapped in a warm burrito shell with some Mexican or
    yellow rice, some blacks beans, and some of the Roasted Tomato Salsa.}
...
\begin{IngredientsAndSteps}
    ...
    \ListIngredientsAndSteps
    {
        ...
        \fr1/4 \tsp cayenne pepper

        \fr1/4 \tsp onion powder

        \fr1/4 \tsp garlic powder / garlic salt
...
\begin{figure}[!hp]
    ...
    \includegraphics[width=\textwidth]{img/fried-chicken.png}
\end{figure}
...
\begin{IngredientsAndSteps}
    ...
    }
    {
        ...
        but not Caitlyn. She prefers it room temperature and before all the pasta soaks up all the wet
        ingredients.
    }
\end{IngredientsAndSteps}
