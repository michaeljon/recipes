...
\begin{IngredientsAndSteps}
    \ListIngredientsAndSteps
    {
        ...
        1\fr1/2 teaspoons light brown sugar
...
\begin{IngredientsAndSteps}
    \ListIngredientsAndSteps[Meatballs]
    {
        ...
        1 bunch basil (about 4 tablespoons chopped)
    ...
    }
    {
        ...
        When the bread is ready, squeeze a bit of the milk out, add \fr1/2 of it and \fr1/2 pound
        ...
        remaining bread and another \fr1/2 pound of ground turkey.
...
\begin{IngredientsAndSteps}
    ...
    \ListIngredientsAndSteps[Wet part]
    {
        ...
        \fr1/2 tablespoon garlic powder

        \fr1/2 tablespoon onion powder
        ...
        1\fr1/2 pounds (one package) chicken tenders
    }
    {}
...
\begin{IngredientsAndSteps}
    \ListIngredientsAndSteps
    {
        ...
        1\fr1/2 tablespoons sambal oelek
        ...
        kosher salt and pepper to taste (about \fr1/2 teaspoon each)
    }
    {
...
\RecipeStory{\lettrine{T}{his sorta, kinda, started} as Nana's meatballs recipe and she would make it every time Caitlyn
...
\begin{IngredientsAndSteps}
    ...
    \ListIngredientsAndSteps[Sauce]
    {
        3 cans of 32oz crushed tomatoes
